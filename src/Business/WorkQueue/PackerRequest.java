 ...
 * @author Dinesh
 */
public class PackerRequest extends WorkQueue{
    ...
    public UserAccount getPacker() {
        return packer;
    }

    public void setPacker(UserAccount packer) {
        this.packer = packer;
    }
