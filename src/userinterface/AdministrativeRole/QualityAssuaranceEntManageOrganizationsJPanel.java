 ...
 * @author shivibhatt
 */
public class QualityAssuaranceEntManageOrganizationsJPanel extends javax.swing.JPanel {
    ...
    public QualityAssuaranceEntManageOrganizationsJPanel(JPanel userProcessContainer, OrganizationDirectory directory, Enterprise enterprise, Network network, EcoSystem system) {
        initComponents();
    ...
    private void populateOrganizationTypeComboBox() {
        ...
        OrganizationTypeComboBox.addItem(Organization.Type.Photographer);
        OrganizationTypeComboBox.addItem(Organization.Type.Inspector);
    }
